...
import { DeletedTransactionsProps } from '@/src/components/interfaces';
import { useState } from 'react';
import List from '../../lists';
import { useRouter } from 'next/navigation';

const DelFinalTransactions: React.FC<DeletedTransactionsProps> = (props) => {
  const {finalTransactions}= props;
